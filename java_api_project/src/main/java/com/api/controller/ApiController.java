	 ...
	 @PostMapping("/{endpoint}")
	    public String getResponse(
		 ...
		 String fullEndpoint =  "/" + endpoint;
	        System.out.println("Endpoint name in ApiController: " + fullEndpoint);
	        return apiService.getResponse(fullEndpoint, requestBody);
	    }

	    @PostMapping("/{version}/{endpoint}")
	    public String getResponseWithoutAction(
	            @PathVariable("version") String version,
	            @PathVariable("endpoint") String endpoint,
	            @RequestBody Map<String, Object> requestBody) {
	        String fullEndpoint = "/" + version + "/" + endpoint;
	        System.out.println("Endpoint name in ApiController: " + fullEndpoint);
	        return apiService.getResponse(fullEndpoint, requestBody);
	    }

	    @PostMapping("/{version}/{action}/{endpoint}") 
	    public String getResponseWithAction(
	            @PathVariable("version") String version,
	            @PathVariable("endpoint") String endpoint,
	            @PathVariable("action") String action,
	            @RequestBody Map<String, Object> requestBody) {
	        String fullEndpoint = "/" + version + "/" + action + "/" + endpoint;
	        System.out.println("Endpoint name in ApiController: " + fullEndpoint);
	        return apiService.getResponse(fullEndpoint, requestBody);
	    }
	    
	    @PostMapping("/{version}/{action}/{endpoint}/{status}") 
	    public String getResponseWithstatus(
	            @PathVariable("version") String version,
	            @PathVariable("endpoint") String endpoint,
	            @PathVariable("action") String action,
	            @PathVariable("status") String status,
	            @RequestBody Map<String, Object> requestBody) {
	        String fullEndpoint = "/" + version + "/" + action + "/" + endpoint+ "/" + status;
	        System.out.println("Endpoint name in ApiController: " + fullEndpoint);
	        return apiService.getResponse(fullEndpoint, requestBody);
	    }
